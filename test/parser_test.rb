...
class ParserTest < Test::Unit::TestCase
  ...
  def test_assign
    ...
    assert_equal Nodes.new([SetAttrNode.new("@a", NumberNode.new(1))]), Parser.new.parse("@a = 1")
  end
...
CODE
    ...
    nodes = Nodes.new([
      IfNode.new(BoolNode.new(true),
        Nodes.new([BoolNode.new(nil)])
      )
    ])
